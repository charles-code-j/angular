...
let FilmeListComponent = class FilmeListComponent {
    constructor(filmeService) {
        this.filmeService = filmeService;
    }
    ngOnInit() {
        const filme = new _model_Filme__WEBPACK_IMPORTED_MODULE_3__["Filme"]();
        filme.id = 1;
        ...
        const filme2 = new _model_Filme__WEBPACK_IMPORTED_MODULE_3__["Filme"]();
        filme2.id = 2;
        filme2.titulo = 'NHA';
...
FilmeListComponent.ctorParameters = () => [
